...
function magic() {
	...
	if (simsubscreennum == 1) {
		...
		if(flag==1)
		{
			...
			animateArrowATPosition(390, 170, 30, 180);
	...
	if (simsubscreennum == 2) {
	     ...
	     if(flag==1)
	     {
			...
			document.getElementById('b24').style.visibility = "visible";
		     ...
		     document.getElementById('nextButton').style.visibility = "hidden";
		     myInt = setInterval(function () { animatearrow(); }, 500);
		     animateArrowATPosition(150, 170, 30, 180);
	...
	if (simsubscreennum == 3) {
		...
		if(flag==1)
		{
			...
			document.getElementById('nextButton').style.visibility = "hidden";
			myInt = setInterval(function () { animatearrow(); }, 500);
			animateArrowATPosition(535, 170, 30, 180);
	...
	if (simsubscreennum == 4) {
            ...
            if(flag==1)
		{
			...
			document.getElementById('nextButton').style.visibility = "hidden";
			myInt = setInterval(function () { animatearrow(); }, 500);
		      animateArrowATPosition(20, 170, 30, 180);
	...
	if (simsubscreennum == 5) {
		...
		if(flag==1)
		{
			...
			document.getElementById('nextButton').style.visibility = "hidden";
			myInt = setInterval(function () { animatearrow(); }, 500);
		animateArrowATPosition(310, 470, 30, 180);
		...
		//document.getElementById('table4').style.visibility = "hidden";
		//document.getElementById('button111').style.visibility = "hidden";
...
function step5() {
			...
			setTimeout(function () {
				...
				setTimeout(function () {
					document.getElementById('v1').innerHTML = data1[r][5];
